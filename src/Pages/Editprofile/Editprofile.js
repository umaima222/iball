                    ...
                    <div class="row profile-h">
                        ...
                        <div class="col-md-5  align-self-center">
                            ...
                            <div class="avatar-edit">
                                ...
                                <input type="file" id="imageUpload" class="custom-file-input" accept=".png, .jpg, .jpeg"/>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="inputName" name="first_name" required="required"/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="oldPassword">Last Name</label>
                                    <input type="text" class="form-control" name="last_name" id="inputLname" required="required"/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="oldPassword">Phone</label>
                                    <input type="tel" class="form-control" id="inputPhone" name="inputPhone" required="Phone"/>
                                </div>
                            </div>
